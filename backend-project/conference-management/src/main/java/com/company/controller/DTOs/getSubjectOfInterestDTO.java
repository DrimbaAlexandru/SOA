...
public class getSubjectOfInterestDTO
{
    ...
    public getSubjectOfInterestDTO(){}

    public getSubjectOfInterestDTO(String searchString, Integer resultsCount, Boolean newlyReported, String searchLink)
    {
